...
// 定義資料庫表格名稱
const table = 'camp_zone'

// 所需的資料處理函式
// 查詢所有資料
const getCampZone = async () => {
...
// ORDER BY id
// LIMIT 0 OFFSET 10;
const getCampZoneWithQS = async (where = '', order = {}, limit = 0, offset) => {
...
// 查詢單一資料，使用id
const getCampZoneById = async (id) => await findOneById(table, id)

// 建立大量商品資料用
const createBulkFacility = async (users) => await insertMany(table, users)
